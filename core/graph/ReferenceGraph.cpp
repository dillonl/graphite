...
namespace graphite
{
	ReferenceGraph::ReferenceGraph(IReference::SharedPtr referencePtr, VariantList::SharedPtr variantListPtr, Region::SharedPtr regionPtr, int matchValue, int misMatchValue, int gapOpenValue, int gapExtensionValue) :
		GSSWGraph(referencePtr, variantListPtr, regionPtr, matchValue, misMatchValue, gapOpenValue, gapExtensionValue)
	{
	}
