...
ExternalProject_Add(SAMTOOLS_PROJECT
    ...
    BUILD_IN_SOURCE 1
    CONFIGURE_COMMAND ""
    BUILD_COMMAND make HTSDIR=${HTSLIB_INCLUDE_DIR} LIBS+=-lcurl LIBS+=-lcrypto
    INSTALL_COMMAND ""
    LOG_DOWNLOAD 0
	LOG_UPDATE 1
    LOG_CONFIGURE 1
...
#${MAKE_COMMAND} HTSDIR=${HTSLIB_INCLUDE_DIR}
#${SAMTOOLS_INSTALL} LDLIBS+=-lcurl LDLIBS+=-lcrypto

SET(SAMTOOLS_INCLUDES  ${SAMTOOLS_DIR}/src/SAMTOOLS_PROJECT/ CACHE INTERNAL "samtools include")
